...
def RSA_encryption(keylen, filename):
    ...
    """
    file_out = open("data/"+filename+".bin", "wb")
...
def RSA(keylen):
    objType = int(input("Choose one of the options:\n1. Encrypt Data\n2. Deecrypt Data"))
...
def main():
    ...
    if(objType == 1):
        ...
        key = int(input("Pick one of the keylengths :\n1. 1024\n2. 2048\n3. 4096\n"))
        if (key == 1):
            keylen = 1024
        elif (key == 2):
            keylen = 2048
